...
public InputStream decryptDataRSA(byte[] encryptedData, PrivateKey decryptionKey) throws CMSException, GeneralSecurityException, IOException, DecryptionError 
	{
	try {
