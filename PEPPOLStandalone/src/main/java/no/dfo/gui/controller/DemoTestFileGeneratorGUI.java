...
public class DemoTestFileGeneratorGUI implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		// warningLabel.setText("Start of application");
		logger.info("Started PEPPOL Test File Generator");
		// LogTextArea.setText("Test Message");
			...
			public void changed(ObservableValue<? extends Toggle> observable, Toggle oldValue, Toggle newValue) {
				if (newValue != null) {
					...
					if (certUsageCategory.equalsIgnoreCase("DemoStore")) {
						...
						/*
						 * EncryptPkcsFile.setVisible(false); EncryptPkcsPassword.setVisible(false);
						 * SigntPkcsFile.setVisible(false); SignPkcsPassword.setVisible(false);
						 */
		...
		DirectoryChooserRepack.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				directoryChooser.setTitle("Select folder for Repacked Files");
